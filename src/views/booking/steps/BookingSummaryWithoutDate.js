...
const BookingSummaryWithoutDate = (props) => {
  const { serviceFee, attendeesAdded, attendees, pricePerson, minimum, salesTax, additionals, calendarEvent, teamClass, bookingId, flipCard } = props
        ...
        <CardBody className="p-2">
          ...
          <div className="text-block pb-0">
            <table className="w-100">
              <tbody>
                <tr>
                  <th className="font-weight-normal text-sm py-1">
                ...
                <tr>
                  <th className="font-weight-normal text-sm py-1">Booking fee ({serviceFee * 100}%)</th>
                  <td className="text-right py-1 text-sm">${totalServiceFee}</td>
                </tr>
                <tr>
                  <th className="font-weight-normal text-sm py-1">Sales Tax ({salesTax * 100}%)</th>
