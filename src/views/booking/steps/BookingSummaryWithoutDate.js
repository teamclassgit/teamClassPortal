          ...
          {date && time && (
            <Media className="pb-1">
              ...
              <Media body>
                ...
                <small>
                  {time} {calendarEvent && calendarEvent.status === 'reserved' && <Badge color="warning">To be confirmed</Badge>}
                  {calendarEvent && calendarEvent.status === 'confirmed' && <Badge color="warning">Accepted</Badge>}
                  {calendarEvent && calendarEvent.status === 'rejected' && <Badge color="warning">Rejected</Badge>}
                </small>
              </Media>
            </Media>
          )}
            ...
            <table className="w-100">
              <tbody>
                ...
                {calendarEvent && calendarEvent.rushFee && (
                  <tr>
                    <th className="font-weight-normal text-sm pb-1">Rush fee ({classRushFee * 100}%)</th>
