...
const AddNewBooking = ({
        ...
        try {
            ...
            const resultCreateBooking = await createBooking({
                variables: {
                    ...
                    classVariant: teamClass.variants[0],
                    ...
                    eventDate: new Date(),
                    eventDurationHours: teamClass.variants[0].duration,
                    attendees: newAttendees,
                    classMinimum: teamClass.variants[0].minimum,
                    pricePerson: teamClass.variants[0].pricePerson,
            ...
            setCustomers([resultCreateBooking.data.upsertOneCustomer, ...customers.filter(element => element._id !== resultCreateBooking.data.upsertOneCustomer._id)])

            // Update bookings object
            setBookings([resultCreateBooking.data.upsertOneBooking, ...bookings.filter(element => element._id !== resultCreateBooking.data.upsertOneBooking._id)])
            setProcessing(false)
        } catch (ex) {
            console.log(ex)
            setProcessing(false)
    ...
    return (
        <Modal isOpen={open} toggle={handleModal} className="sidebar-sm" modalClassName="modal-slide-in"
            ...
            <ModalBody className="flex-grow-1">
                ...
                <Button
                    ...
                    disabled={
                        ...
                        !newAttendees || processing || !attendeesValid || !selectedClass
                    }
                >
